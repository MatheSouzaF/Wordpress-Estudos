...
// MENUS
function engie_deregister_menu()
{
    //Remover suporte a menu
}
add_action('init', 'engie_deregister_menu');
...
function custom_setup()
{
    ...
    // Languages
    load_theme_textdomain('engie_2023', get_template_directory() . '/languages');
